...
import com.buildit.procurement.application.dto.Team2PlantInventoryEntryDTO;
import com.buildit.procurement.web.controller.PlantHireRequestController;
import org.springframework.hateoas.mvc.ResourceAssemblerSupport;
import org.springframework.stereotype.Service;

@Service
public class Team2ToBuildItPlantInventoryEntryAssembler extends ResourceAssemblerSupport<Team2PlantInventoryEntryDTO, PlantInventoryEntryDTO> {

	public Team2ToBuildItPlantInventoryEntryAssembler() {
		super(PlantHireRequestController.class, PlantInventoryEntryDTO.class);
	}

	@Override
	public PlantInventoryEntryDTO toResource(Team2PlantInventoryEntryDTO plant) {
